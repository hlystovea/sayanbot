...
class MongoDB:
    ...
    async def find_one_resort(
        self, kwargs: Dict | None = None
    ) -> Optional[Resort]:  # noqa (E501)
    ...
    async def find_one_track(
        self, kwargs: Dict | None = None
    ) -> Optional[Track]:  # noqa (E501)
    ...
    async def update_track_by_unique_id(
        self, unique_id: str, kwargs: Dict | None = None
    ) -> int:  # noqa (E501)
        result = await self.tracks_collection().update_one(
            {'unique_id': unique_id}, {'$set': kwargs or {}}
        )
    ...
    async def find_many_tracks(
        self, kwargs: Dict | None = None, length: int | None = None
    ) -> List[Track]:  # noqa (E501)
